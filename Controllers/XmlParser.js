...
//   // Prefer GLI.Last_Website_Published_Date_Time â†’ else fallback to propertyData.created_at (already mapped by you)
//   const publishedAtString =
//     (gi.Last_Website_Published_Date_Time &&
//       String(gi.Last_Website_Published_Date_Time).trim()) ||
//     propertyData.created_at ||
...
//     // keep lastUpdated as you had it (itâ€™s fine)
//     lastUpdated:
//       parseXmlTsAsUTC(gi.Last_Website_Published_Date_Time) || new Date(),
//   };
// };
...
//     // 1) Try update-in-place (positional operator) â†’ force overwrite ALL fields incl. addedDate
//     const upd = await Agent.updateOne(
//       { _id: existingAgent._id, "properties.propertyId": propertyData.id },
//       { $set: { "properties.$": payload } }
//     );
...
//     // 2) Not present â†’ push a fresh record
//     await Agent.updateOne(
//       { _id: existingAgent._id },
//       { $push: { properties: payload } }
//     );
...
//           updates.created_at = propertyData.created_at;
//           shouldUpdate = true;
//           console.log(`[${id}] ðŸ“… Updating created_at:`, propertyData.created_at);
//         }
//         if (propertyData.address_information && Object.keys(propertyData.address_information).length > 0) {
//           updates.address_information = propertyData.address_information;
//           shouldUpdate = true;
//           console.log(`[${id}] ðŸ“ Adding/Updating address_information:`, propertyData.address_information);
//         }
//         if (shouldUpdate) {
//           propertyOps.push({
//             updateOne: {
...
// // Cron job for every 2 hours â€” call controller directly (no HTTP call)
// const schedulePropertySync = () => {
//   const TZ = process.env.CRON_TZ || "Etc/UTC";
//   cron.schedule(
//     "*/150 * * * *",
...
//             };
//             console.log(
//               `âœ… [${new Date().toISOString()}] Property sync completed:`,
//               summary
//             );
//           } catch (e) {
//             console.log(
...
//       } catch (error) {
//         console.error(
//           `âŒ [${new Date().toISOString()}] Property sync failed:`,
//           error.message
//         );
//       }
//     },
...
//   console.log("â° Property sync scheduler initialized - Running every 2 hours");
// };
