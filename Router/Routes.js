...
router.get("/SingleNewsBySlug", News.getNewsBySlug);
...
router.get("/SinglePodcastBySlug", Podcast.getPodcastBySlug);
...
router.get("/force-full-resync", ParseXml.forceFullResync);
